...
SECRET_KEY = 'django-insecure-5s0f+)d=elg1xc7q+opqq@wu@l#w-9x$pt#=5=njp$g-bfy$x^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["handshake-cghc.onrender.com", "127.0.0.1","localhost"] 
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:8000",
    "http://127.0.0.1:8000",
    "https://handshake-naturescot.onrender.com"
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (  # Fixed typo here
...
SIMPLE_JWT = {
    ...
    'ROTATE_REFRESH_TOKENS': True,                    # Rotate refresh tokens (recommended)
...
FRONTEND_BASE_URL = "https://handshake-naturescot.onrender.com"
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'handshake.scot@gmail.com'
EMAIL_HOST_PASSWORD = 'phzh plox gfdr uxre'
DEFAULT_FROM_EMAIL = 'Handshake noreply@handshake.com'
...
# Change this for better security later:
